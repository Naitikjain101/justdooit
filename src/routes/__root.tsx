...
const DARK_INIT = `(function(){try{var s=localStorage.getItem('taskflow.theme');var d=s?s==='dark':window.matchMedia('(prefers-color-scheme: dark)').matches;if(d)document.documentElement.classList.add('dark');}catch(e){}})();`;
